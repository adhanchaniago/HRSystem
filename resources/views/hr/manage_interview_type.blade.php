...
@section('content')
    <div class="page-content fade-in-up">
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title"><i class="fa fa-plus"></i> Add New Interview Type</h4>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>

                            <form action="{{url("/interview/add-new-type")}}" method="post">
                            {{csrf_field()}}

                            <!-- Modal body -->
                                <div class="modal-body">
                                    <div class="form-group">
                                        <input type="text" name="interview_type_name" placeholder="Input Interview Type Name" class="form-control" required>
                                    </div>
                                </div>
        ...
        <div class="row">
            @foreach($intvType as $type)
                <div class="col-md-4">
                    <div class="ibox">
                        <div class="ibox-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <h4 class="p-t-15 p-l-15">{{$type->department_name}}</h4>
                                </div>
                                <div class="col-md-2">
                                    <div>
